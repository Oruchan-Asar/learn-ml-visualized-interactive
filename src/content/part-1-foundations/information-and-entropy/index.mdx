...
<Formalize>
  ...
  <Steps>
    <Step label="Zero when certain">
      It's exactly zero when one outcome is certain.
    </Step>
    <Step label="Maximal when uniform">
      It's largest exactly when every outcome is equally likely — uncertainty is maximized when you have
      the least information to favor any one outcome.
    </Step>
  </Steps>
</Formalize>
