...
<WorkedExample>
  ...
  $$
  H(X) = 0.5(1) + 0.25(2) + 0.125(3) + 0.125(3) = 0.5+0.5+0.375+0.375 = 1.75 \text{ bits}
  $$

  Each term is $-p\log_2 p$ — here the probabilities are all powers of two, so every term comes out to a whole number of bits.
</WorkedExample>
