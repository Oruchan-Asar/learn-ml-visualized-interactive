...
import { apply, ROTATE_90, SCALE, SHEAR, PROJECT_X, type Mat2 } from "@/lib/math-core/matrices";
...
const CONCEPT_ID = "matrices-as-linear-transformations";
...
const PRESETS = [
  ...
  { key: "project", label: "Project", matrix: PROJECT_X },
] as const;
