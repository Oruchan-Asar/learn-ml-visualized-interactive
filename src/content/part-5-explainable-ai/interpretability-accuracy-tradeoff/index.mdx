...
<Formalize>
  ...
  This interpretability score is a stand-in for something real: a model built from a handful of regions is one a person can hold in their head and restate as a short list of rules. A model built from dozens of regions — one for nearly every data point — has traded that away for the ability to fit exceptions no simple rule ever could.
</Formalize>
