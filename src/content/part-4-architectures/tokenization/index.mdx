...
<WorkedExample>
  Tokenizing "lowest" from scratch: $l\ o\ w\ e\ s\ t\ \langle/w\rangle$. Applying the learned merges in order — $e{+}s\to es$, then $es{+}t\to est$, then $est{+}\langle/w\rangle \to est\langle/w\rangle$, then $l{+}o\to lo$, then $lo{+}w\to low$ — leaves exactly two tokens: $low$ and $est\langle/w\rangle$. Every merge rule came from *low*, *lower*, *newest*, and *widest* alone; "lowest" itself was never part of training.
</WorkedExample>
