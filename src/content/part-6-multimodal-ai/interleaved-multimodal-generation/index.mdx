...
<WorkedExample>
  ...
  <Steps>
    <Step label="Exponentiate each logit">
      - "top-left": $e^{2}\approx 7.389$
      - "of": $e^{-1}\approx 0.368$
      - "the": $e^{-1}\approx 0.368$
    </Step>
    <Step label="Normalize into weights">
      Sum $\approx 7.389+0.368+0.368=8.125$. Dividing each by that sum:
      - "top-left": $7.389/8.125\approx0.909$
      - "of": $0.368/8.125\approx0.045$
      - "the": $0.368/8.125\approx0.045$
