...
import ChapterContent from "@/content/decentralized-systems/capstone-raft-leader-election-by-hand/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "capstone-raft-leader-election-by-hand";
