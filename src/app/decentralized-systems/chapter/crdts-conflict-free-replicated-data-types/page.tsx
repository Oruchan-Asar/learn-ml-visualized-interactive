...
import ChapterContent from "@/content/decentralized-systems/crdts-conflict-free-replicated-data-types/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "crdts-conflict-free-replicated-data-types";
