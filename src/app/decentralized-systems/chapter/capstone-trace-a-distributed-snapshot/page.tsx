...
import ChapterContent from "@/content/decentralized-systems/capstone-trace-a-distributed-snapshot/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "capstone-trace-a-distributed-snapshot";
