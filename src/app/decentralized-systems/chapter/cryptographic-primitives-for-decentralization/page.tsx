...
import ChapterContent from "@/content/decentralized-systems/cryptographic-primitives-for-decentralization/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "cryptographic-primitives-for-decentralization";
