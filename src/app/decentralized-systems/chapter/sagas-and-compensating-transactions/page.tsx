...
import ChapterContent from "@/content/decentralized-systems/sagas-and-compensating-transactions/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "sagas-and-compensating-transactions";
