...
import ChapterContent from "@/content/decentralized-systems/sybil-attacks-and-economic-security/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "sybil-attacks-and-economic-security";
