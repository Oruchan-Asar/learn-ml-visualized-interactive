...
import ChapterContent from "@/content/decentralized-systems/gossip-protocols-and-epidemic-dissemination/ClientContent";

const COURSE = getCourse("decentralized-systems");
const SLUG = "gossip-protocols-and-epidemic-dissemination";
