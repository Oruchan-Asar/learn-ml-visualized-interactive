...
import ChapterContent from "@/content/part-1-foundations/conditional-probability-and-bayes-rule/ClientContent";

const SLUG = "conditional-probability-and-bayes-rule";
