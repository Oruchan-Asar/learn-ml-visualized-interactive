...
import ChapterContent from "@/content/part-4-architectures/self-attention-and-multi-head-attention/ClientContent";

const SLUG = "self-attention-and-multi-head-attention";
