...
import ChapterContent from "@/content/part-16-advanced-generative-models/score-based-generative-models/ClientContent";

const SLUG = "score-based-generative-models";
