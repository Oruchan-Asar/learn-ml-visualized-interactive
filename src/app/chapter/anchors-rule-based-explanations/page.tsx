...
import ChapterContent from "@/content/part-11-explainability-continued/anchors-rule-based-explanations/ClientContent";

const SLUG = "anchors-rule-based-explanations";
