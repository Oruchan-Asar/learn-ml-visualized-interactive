...
import ChapterContent from "@/content/part-10-advanced-architectures/semantic-segmentation-and-unet/ClientContent";

const SLUG = "semantic-segmentation-and-unet";
