...
import ChapterContent from "@/content/part-7-reinforcement-learning/proximal-policy-optimization-ppo/ClientContent";

const SLUG = "proximal-policy-optimization-ppo";
