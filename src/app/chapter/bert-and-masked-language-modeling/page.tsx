...
import ChapterContent from "@/content/part-10-advanced-architectures/bert-and-masked-language-modeling/ClientContent";

const SLUG = "bert-and-masked-language-modeling";
