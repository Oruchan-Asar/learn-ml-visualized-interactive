...
import ChapterContent from "@/content/part-19-production-ml-systems/distributed-training-parallelism/ClientContent";

const SLUG = "distributed-training-parallelism";
