...
import ChapterContent from "@/content/part-9-model-evaluation/confusion-matrix-precision-recall-f1/ClientContent";

const SLUG = "confusion-matrix-precision-recall-f1";
