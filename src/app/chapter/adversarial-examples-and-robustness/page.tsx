...
import ChapterContent from "@/content/part-18-alignment-and-safety/adversarial-examples-and-robustness/ClientContent";

const SLUG = "adversarial-examples-and-robustness";
