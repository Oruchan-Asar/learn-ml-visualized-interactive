...
import ChapterContent from "@/content/part-19-production-ml-systems/vector-databases-and-ann-search/ClientContent";

const SLUG = "vector-databases-and-ann-search";
