...
import ChapterContent from "@/content/part-9-model-evaluation/capstone-evaluate-a-real-pipeline/ClientContent";

const SLUG = "capstone-evaluate-a-real-pipeline";
