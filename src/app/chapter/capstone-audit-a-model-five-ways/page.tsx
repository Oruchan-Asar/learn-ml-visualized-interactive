...
import ChapterContent from "@/content/part-11-explainability-continued/capstone-audit-a-model-five-ways/ClientContent";

const SLUG = "capstone-audit-a-model-five-ways";
